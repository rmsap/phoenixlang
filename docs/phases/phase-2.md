...
With Phase 2.5 closed, **Phase 3.1 (package manager)** — which carries the deferred `import js "pkg"` / `[js-dependencies]` / npm-resolution slice — becomes the natural next active phase.
